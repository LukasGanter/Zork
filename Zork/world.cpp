    ...
    Entity(title, description)
{
    ...
    Item* mountain_item_3 = new LetterFragment("letter mountain (3)", "A message from the king.\n\n5 bandits are travelling the lands. Be aware!", ValueTokens::LETTER_FRAGMENT_MOUNTAINS);
    ...
    Item* ravine_item_1 = new LetterFragment("letter ravine (5)", "A planned trap.\n\nA suspension bridge with one loose board.", ValueTokens::LETTER_FRAGMENT_RAVINE);
    Item* ravine_item_2 = new Shield("sturdy shield", "A sturdy round shield", ValueTokens::STURDY_SHIELD, 1, 1, 10, 80);

    Item* cave_item_1 = new LetterFragment("letter cave (4)", "So dark that the light of the torch does not reach the far sides.\n\nI swear, the big stone in the corner moved. 9 times!", ValueTokens::LETTER_FRAGMENT_CAVE);

    Connector* mountains_connector_1 = new Connector("Door", "The north door of the hut", ValueTokens::HUT_ROOM, new Storyline({ "With a screech the heavy door opens and gives way to a cosy living room.\nYou walk in...\n" }), ValueTokens::NORTH, true, ValueTokens::KEY_METAL, 0, 0);
