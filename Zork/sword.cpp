...
{
	std::cout << "You decide to attack "<< attacked_npc->title << " using your mighty sword.\n";
	print_stats();
...
int Sword::defend_attack(const NPC* attacking_npc)
{
	std::cout << "You defend yourself using your mighty sword.\n";
	print_stats();
...
{
	std::cout << "You decide to destroy the obstacle using your mighty sword.\n";
	print_stats();
